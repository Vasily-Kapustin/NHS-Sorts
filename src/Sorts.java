...
public class Sorts {
    ...
    /** Sort and array using insertionSort
     * Parse through each data and move it back until there is a smaller value before it
     * @param list A Comparable list which is going to be sorted
     * @return sorted array 
     */
